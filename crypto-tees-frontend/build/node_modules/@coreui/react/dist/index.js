...
var CCollapse = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement(CSSTransition, { in: visible, timeout: 350, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited }, function (state) {
...
var CAlert = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement(CSSTransition, { in: _visible, timeout: 150, onExit: onDismiss, onExited: onDismissed, unmountOnExit: true },
        React__default['default'].createElement("div", __assign({ className: _className, role: "alert" }, rest, { ref: ref }),
            children,
...
var CBreadcrumbItem = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement("li", __assign({ className: classNames('breadcrumb-item', active ? 'active' : false, className) }, (active && { 'aria-current': 'page' }), rest, { ref: ref }), href ? React__default['default'].createElement(CLink, { href: href }, children) : children));
});
...
var CCarouselControl = React.forwardRef(function (_a, ref) {
    var className = _a.className, children = _a.children, direction = _a.direction, rest = __rest(_a, ["className", "children", "direction"]);
    var _b = React.useContext(CCarouselContext), state = _b.state, setState = _b.setState, itemsNumber = _b.itemsNumber, animating = _b.animating;
    ...
    return (React__default['default'].createElement("button", __assign({ className: anchorClasses }, rest, { onClick: onClick, ref: ref }), children || (React__default['default'].createElement("span", { className: "carousel-control-" + direction + "-icon", "aria-label": direction }))));
});
...
var CCarouselIndicators = React.forwardRef(function (_a, ref) {
    var className = _a.className, _b = _a.indicatorsClass, indicatorsClass = _b === void 0 ? 'carousel-indicators' : _b;
    var _c = React.useContext(CCarouselContext), itemsNumber = _c.itemsNumber, state = _c.state, setState = _c.setState, animating = _c.animating;
    ...
    var indicators = Array.from({ length: itemsNumber }, function (_, i) { return i; }).map(function (key) {
        return (React__default['default'].createElement("li", { key: "indicator" + key, onClick: function () {
                !animating && key !== state[1] && setState([state[1], key]);
            }, className: state[1] === key ? 'active' : '', "data-coreui-target": "" }));
    });
    return (React__default['default'].createElement("ol", { className: listClasses, ref: ref }, indicators));
});
...
var CCarouselInner = React.forwardRef(function (_a, ref) {
    var children = _a.children, className = _a.className, rest = __rest(_a, ["children", "className"]);
    var setItemsNumber = React.useContext(CCarouselContext).setItemsNumber;
    var _className = classNames('carousel-inner', className);
    React.useEffect(function () {
        setItemsNumber(React.Children.toArray(children).length);
    });
    return (React__default['default'].createElement("div", __assign({ className: _className }, rest, { ref: ref }), React.Children.map(children, function (child, index) {
...
var CCarousel = React.forwardRef(function (_a, ref) {
    ...
    var _e = React.useState([null, index]), state = _e[0], setState = _e[1];
    var _f = React.useState(0), itemsNumber = _f[0], setItemsNumber = _f[1];
    ...
    return (React__default['default'].createElement("div", __assign({ className: _className, onMouseEnter: pause, onMouseLeave: cycle }, rest, { ref: ref }),
        React__default['default'].createElement(CCarouselContext.Provider, { value: {
            ...
            indicators && React__default['default'].createElement(CCarouselIndicators, null),
            React__default['default'].createElement(CCarouselInner, null, children),
            controls && (React__default['default'].createElement(React__default['default'].Fragment, null,
                React__default['default'].createElement(CCarouselControl, { direction: "prev" }),
                React__default['default'].createElement(CCarouselControl, { direction: "next" }))))));
});
CCarousel.propTypes = {
...
var CCarouselItem = React.forwardRef(function (_a, ref) {
    ...
    var _b = React.useContext(CCarouselContext), animate = _b.animate, state = _b.state, animating = _b.animating, setAnimating = _b.setAnimating;
    var _c = React.useState(false), isIn = _c[0], setIsIn = _c[1];
    ...
    if (!animate || state[0] === null) {
        ...
        return (React__default['default'].createElement("div", __assign({ className: itemClasses, ref: ref }, rest), children));
    }
    return (React__default['default'].createElement(CSSTransition, { timeout: 600, in: isIn, onEnter: onEnter, onEntering: onEntering, onExit: onExit, onExiting: onExiting, onExited: onExited, nodeRef: ref }, function (status) {
...
var CFormControl = React.forwardRef(function (_a, ref) {
    var _b;
    ...
    var _className = classNameParent
        ...
        : classNames(plainText ? 'form-control-plaintext' : 'form-control', (_b = {
            ...
            _b['is-valid'] = valid,
            _b), className);
    return (React__default['default'].createElement(Component, __assign({}, (Component === 'input' && { type: type }), { className: _className }, rest, { ref: ref }), children));
});
...
var CFormCheck = React.forwardRef(function (_a, ref) {
    ...
    var formControl = function () {
        return (React__default['default'].createElement(CFormControl, __assign({ type: type, classNameParent: inputClassName, id: id }, rest, { ref: ref })));
    };
    var formLabel = function () {
        return (React__default['default'].createElement(CFormLabel, __assign({ classNameParent: labelClassName }, (id && { htmlFor: id })), label));
    };
    return _switch ? (React__default['default'].createElement("div", { className: _className },
        formControl(),
        label && formLabel())) : button ? (React__default['default'].createElement(React__default['default'].Fragment, null,
        formControl(),
...
var CModal = React.forwardRef(function (_a, ref) {
    ...
    var _g = React.useState(false), staticBackdrop = _g[0], setStaticBackdrop = _g[1];
...
var CModalHeader = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement("div", __assign({ className: _className }, rest, { ref: ref }),
        children,
        onDismiss && React__default['default'].createElement(CCloseButton, { onClick: onDismiss })));
});
...
var CNavGroup = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement("li", __assign({ className: _className }, rest, { ref: ref }),
        toggler && (React__default['default'].createElement("a", { className: "nav-link nav-group-toggle", onClick: function (event) {
                event.preventDefault();
            ...
            icon && typeof icon === 'string' ? React__default['default'].createElement("i", { className: "nav-icon " + icon }) : icon,
            toggler)),
        React__default['default'].createElement(Transition, { in: _visible, timeout: 300, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited }, function (state) { return (React__default['default'].createElement("ul", { className: "nav-group-items", style: __assign(__assign({}, style), transitionStyles[state]), ref: navItemsRef }, React__default['default'].Children.map(children, function (child, index) {
            if (React__default['default'].isValidElement(child)) {
...
var CNavLink = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement(CLink, __assign({ className: _className }, rest, { ref: forkedRef }),
        icon && typeof icon === 'string' ? React__default['default'].createElement("i", { className: "nav-icon " + icon }) : icon,
        children));
});
CNavLink.propTypes = {
...
var CPopover = function (_a) {
    ...
    return (React__default['default'].createElement(Manager, null,
        ...
        typeof window !== 'undefined' &&
            ReactDOM.createPortal(React__default['default'].createElement(CSSTransition, { in: _visible, timeout: {
                    enter: 0,
                    exit: 200,
...
var CCreateNavItem = function (_a) {
    ...
    var renderItem = function (item, index, idx) {
        ...
        return (React__default['default'].createElement(Component, __assign({ component: as, key: index }, (items && { idx: idx + "." + index, toggler: anchor }), rest), children));
    };
...
var CSpinner = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement(Component, __assign({ className: _className, role: "status" }, rest, { ref: ref }),
        React__default['default'].createElement("span", { className: "visually-hidden" }, "Loading...")));
});
CSpinner.propTypes = {
    className: PropTypes.string,
    color: colorPropType,
...
var CTabPane = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement(Transition, { in: visible, timeout: 350 }, function (state) {
        var transitionClass = getTransitionClass(state);
        return (React__default['default'].createElement("div", __assign({ className: classNames(_className, transitionClass), style: __assign({}, style) }, rest, { ref: ref }), children));
    }));
});
CTabPane.propTypes = {
    children: PropTypes.node,
...
var CToastHeader = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement("div", __assign({ className: _className }, rest, { ref: ref }),
        children,
        close && React__default['default'].createElement(CToastClose, null)));
});
...
var CWidgetBrand = React.forwardRef(function (_a, ref) {
    var _b;
            ...
            values.map(function (value, index) {
                return (React__default['default'].createElement(React__default['default'].Fragment, { key: index },
                    ...
                    React__default['default'].createElement(CCol, null,
                        React__default['default'].createElement("div", { className: "fs-5 fw-semibold" }, value[0]),
                        React__default['default'].createElement("div", { className: "text-uppercase text-medium-emphasis small" }, value[1]))));
            }));
    }, [JSON.stringify(values)]);
    return (React__default['default'].createElement(CCard, __assign({ className: _className }, rest, { ref: ref }),
        React__default['default'].createElement(CCardHeader, { className: classNameHeader }, headerChildren),
        React__default['default'].createElement(CCardBody, { className: "row text-center" }, generatedItems)));
});
...
var CWidgetDropdown = React.forwardRef(function (_a, ref) {
    var _b;
...
var CWidgetIcon = React.forwardRef(function (_a, ref) {
    ...
    var _className = classNames(className);
    return (React__default['default'].createElement(CCard, __assign({ className: _className }, rest, { ref: ref }),
        React__default['default'].createElement(CCardBody, { className: "d-flex align-items-center p-" + padding },
            React__default['default'].createElement("div", { className: "me-3 text-white bg-" + color + " p-" + iconPadding }, icon),
            React__default['default'].createElement("div", null,
...
var CWidgetProgress = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement(CCard, __assign({ className: className, color: color, textColor: textColor }, rest, { ref: ref }),
        React__default['default'].createElement(CCardBody, null,
            value && React__default['default'].createElement("div", { className: "fs-4 fw-semibold" }, value),
            title && React__default['default'].createElement("div", null, title),
            React__default['default'].createElement(CProgress, { className: "my-2", color: progressColor, height: 4, value: progressValue, white: progressWhite }),
            text && React__default['default'].createElement("small", { className: "text-medium-emphasis" }, text))));
});
...
var CWidgetProgressIcon = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement(CCard, __assign({ className: className, color: color, textColor: textColor }, rest, { ref: ref }),
        React__default['default'].createElement(CCardBody, null,
            icon && (React__default['default'].createElement("div", { className: "text-medium-emphasis" + (color ? '-inverse' : '') + " text-end mb-4" }, icon)),
            value && (React__default['default'].createElement("div", { className: "text-high-emphasis" + (color ? '-inverse' : '') + " fs-4 fw-semibold" }, value)),
            title && (React__default['default'].createElement("div", { className: "text-medium-emphasis" + (color ? '-inverse' : '') + " text-uppercase fw-semibold small" }, title)),
            React__default['default'].createElement(CProgress, { className: "mt-3 mb-0", color: progressColor, height: 4, value: progressValue, white: progressWhite }))));
});
...
var CWidgetSimple = React.forwardRef(function (_a, ref) {
...
exports.CCreateNavItem = CCreateNavItem;
...
exports.CFormControl = CFormControl;
